package com.vicheanath.waa.config;


import com.vicheanath.waa.filter.JwtFilter;
...
//  String [] roles = {"CLIENT"}; // Try this :)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(req -> req.requestMatchers("/api/v1/authenticate/**")
                        .permitAll()
                        .requestMatchers("/api/v1/users/admin/**").hasAnyRole("ADMIN")
                        .requestMatchers("/api/v1/posts/**").hasAnyRole(roles)
